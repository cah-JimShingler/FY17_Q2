(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('fy17Q2App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-fy17Q2App-error');
                var entityKey = httpResponse.headers('X-fy17Q2App-params');
                if (errorHeader) {
